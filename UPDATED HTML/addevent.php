...
<form action="addEventScript.php" method="post">
  <fieldset>
    ...
    Location:
	<input type="text" name="addName" value="Location Name" class="form-control"><br>
    ...
    Starting Time of Event: <input type="text" name="eventStart" value="Start Time   (Example: 2017-01-12 15:00:00 )" class="form-control"> <br>
